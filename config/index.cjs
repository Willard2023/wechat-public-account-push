...
const USER_CONFIG = {
  ...
  USERS: [
    {
      ...
      useTemplateId: '6_-3mrvlDLqy6H0qwqXySZNx-1oQ5xsQYqFiDrSSNu88',
      // 新历生日, 仅用作获取星座运势, 格式必须为MM-DD
      horoscopeDate: '12-27',
      festivals: [
        // // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
        {
          type: '*生日', name: '梦倩宝宝', year: '2001', date: '07-06',
        },
  ...
  CALLBACK_TEMPLATE_ID: '6_-3mrvlDLqy6H0qwqXySZNx-1oQ5xsQYqFiDrSSNu8',
